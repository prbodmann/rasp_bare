...
ifeq ($(strip $(RASPPI)),3)
ARCH	?= -DAARCH=64 -Ofast -march=armv8-a -mcpu=cortex-a53 -mlittle-endian -mcmodel=small -floop-optimize -falign-loops -falign-labels -falign-functions -falign-jumps -fomit-frame-pointer -funroll-loops -lm
TARGET	?= kernel8
else ifeq ($(strip $(RASPPI)),4)
ARCH	?= -DAARCH=64 -Ofast -march=armv8-a -mcpu=cortex-a72 -floop-optimize -falign-loops -falign-labels -falign-functions -falign-jumps -fomit-frame-pointer -funroll-loops -lm
TARGET	?= kernel8-rpi4
else
...
INCLUDE	+= -I $(CIRCLEHOME)/include -I $(CIRCLEHOME)/addon -I $(CIRCLEHOME)/experiments -I $(CIRCLEHOME)/app/lib \
